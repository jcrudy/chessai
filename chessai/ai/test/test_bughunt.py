...
#     board = BitBoardState.from_fen('8/6p1/2p2b2/7p/6p1/4K3/k6r/1q6 b - - 13 50')
    ...
    board = BitBoardState.from_fen('8/6q1/8/K7/8/5k2/6p1/8 b - - 25 100')
...
#     for i in range(10):
#         print i
#         print player.movesearch(board, i);
    print player.movesearch(board, 4);
    print player.movesearch(board, 5);
    print player.movesearch(board, 6);
    print player.movesearch(board, 7, debug=True);
